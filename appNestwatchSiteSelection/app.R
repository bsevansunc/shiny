    ...
    sidebarPanel(h3(strong('Site selection dashboard')),
      ...
      # Data upload, exhisting sites:
        h4(strong('2. Upload existing site data:')),
          p('Important! The input file must be a three-column csv file of exiting Neighborhood Nestwatch sites with the fields "siteID","longitude" and "latitude" provided in that order.'),
      ...
      # Define resolution Resolution:
        h4(strong('4. Provide the target resolution:')),
          p('This is the distance in meters from each household center for which you will calculate the proportion of impervious surface'),
          numericInput('radius','',500, 50, 5000, step = 50),
      # Submit data for analysis:
        h4(strong('5. Get summary data!')),
        submitButton('Submit!'),
        br(),
      # Download output:
        h4(strong('6. Download output')),
          p('Use the button below if you would like to download a csv file of the proportion of impervious surface surrounding existing and potential sites.'),
